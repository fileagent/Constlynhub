...
local LoadingXSX = Notif:Notify("Loading Constlynhub lib v2, please be patient.", 5, "information") 

library.title = "Constlynhub"
...
local Button2 = Label1:NewButton("teleport to beta dinner ", function()
    game:GetService("TeleportService"):Teleport(15989668274)
end)
local Button3 = Label1:NewButton("teleport to beta bakery ", function()
    game:GetService("TeleportService"):Teleport(16142203369)
end)
local Keybind1 = Label1:NewKeybind("Keybind 1", Enum.KeyCode.RightAlt, function(key)
